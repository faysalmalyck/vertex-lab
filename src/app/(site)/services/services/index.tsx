  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <h2
          className="premium-heading mx-auto mt-6 max-w-3xl text-center"
          data-aos="fade-up"
          data-aos-delay="200"
        >
          Build Real Software That Solves Business Problems
        </h2>

        <p
          className="mx-auto mt-6 mb-16 max-w-2xl text-center text-lg leading-8 text-gray-600 dark:text-white/60"
          data-aos="fade-up"
          data-aos-delay="350"
        >
          We design, develop, and optimize modern software solutions that help
          businesses launch faster, scale confidently, and deliver exceptional digital
          experiences.
        </p>
